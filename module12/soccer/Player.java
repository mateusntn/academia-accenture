...
public class Player {
    ...
    public Player(int id, String name, LocalDate birthDate, int number, String position, double quality,
    ...
    public String toString() {
        ...
        return Position + ": " + Number + " - " + Name + " - " + BirthDate + " | CONDITION: " + (Suspended ? "Suspended" : "Can Play") + " | Quality: " + Quality;
    }
